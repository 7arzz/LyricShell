...
export default function TerminalPreview({ songInfo, lrcContent }) {
  ...
  useEffect(() => {
    ...
    const bootSequence = [
      ...
      { text: "[ OK ] BOOT SEQUENCE COMPLETE. PLAYBACK HANDOFF INITIALIZED.", color: "text-green-400 font-bold", delay: 3200 },
      { clear: true, delay: 3800 },
      { text: "━".repeat(45), color: "text-cyan-500/60", delay: 3900 },
      { text: "  [ AUDIO ENGINE ONLINE ]  [ LYRIC STREAM ACTIVE ]", color: "text-cyan-400 font-bold", delay: 4000 },
      { text: "━".repeat(45), color: "text-cyan-500/60", delay: 4100 },
      { text: "", delay: 4200 },
